...
func main() {
	...
	if err != nil {
		...
		fmt.Printf("✅ Valid data passed validation\n")
	}
	...
	if err != nil {
		...
		fmt.Printf("❌ Invalid data incorrectly accepted\n")
	}
	...
	if err != nil {
		fmt.Printf("❌ Output validation failed: %v\n", err)
	} else {
	...
	if err != nil {
		fmt.Printf("❌ Coordinator input validation failed: %v\n", err)
	} else {
		fmt.Printf("✅ Coordinator input validation passed\n")
	}

	// Test output validation through coordinator
	err = coordinator.ValidateOutput(cap.UrnString(), validOutput)
	if err != nil {
		fmt.Printf("❌ Coordinator output validation failed: %v\n", err)
	} else {
		fmt.Printf("✅ Coordinator output validation passed\n")
	}
	...
	if err != nil {
		...
		fmt.Printf("✅ Valid array passed validation\n")
	}
