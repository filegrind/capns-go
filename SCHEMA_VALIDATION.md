# JSON Schema Validation for capns-go and fgrnd-plugin-sdk-go
...
**File: `fgrnd-plugin-sdk-go/sdk.go`**
...
```go
import sdk "github.com/jowharshamshiri/fgrnd-plugin-sdk-go"
...
caller := registry.Can("cap:action=query;target=structured;")
